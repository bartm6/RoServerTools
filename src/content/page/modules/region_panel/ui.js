...
const rsdNormalizeRegionCode =
  ...
  const mapLimit =
    __u.mapLimit || (async (items, _limit, it) => Promise.all(items.map(it)));
  ...
  function rsdDisableTooltips(root) {
    try {
      ...
      const strip = (node) => {
        ...
        } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:69", error); }
      };
    ...
    } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:93", error); }
  }
      ...
      if (window.location.pathname.includes("/games/")) {
        ...
        function scheduleUiUpdate() {
          ...
          setTimeout(async () => {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:148", error); }
          }, 150);
        }
        ...
        } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:238", error); }
        const __theme =
            ...
            ? globalThis.RSD.createJoin({
                ...
                fns: {
                  ...
                  openSidePanelIfEnabled: (region) => {
                    ...
                    } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:298", error); }
                    return false;
                  },
                },
              })
        ...
        function rsdRefreshOpenSidePanel(changedRegion) {
          ...
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:396", error); }
        }
        ...
        const calculateDistance =
          globalThis.RSD?.region_panel?.utils?.calculateDistance ||
          globalThis.RSD?.utils?.haversineKm ||
          (() => NaN);
        async function joinSpecificRegion(region) {
          ...
          rsdWarnOnce(
            "src/content/page/modules/region_panel/ui.js:missing-joinSpecificRegion",
            new Error("Join module unavailable"),
          );
        }
        ...
        function joinSpecificServer(serverId) {
          ...
          rsdWarnOnce(
            "src/content/page/modules/region_panel/ui.js:missing-joinSpecificServer",
            new Error("Join module unavailable"),
          );
        }
            ...
            const fetchPromise = (async () => {
              try {
                ...
                if (!warned) {
                  ...
                  } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:540", error); }
        ...
        async function updateDetailsServers(retries = 5) {
            ...
            if (regionDropdown && regionListContainer) {
              ...
              try {
                ...
                if (sp && sp.classList.contains("rsd-open")) {
                  ...
                  } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:644", error); }
                  const rc = sp.dataset.rsdRegion;
                  if (rc) {
                    await rsdOpenRegionSidePanel(rc, true);
                  }
                }
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:650", error); }
              return;
            } else {
          ...
          try {
            globalThis.RSD?.history_panel?.bindButton?.(recentButton, {
              overlay: document.getElementById("RSD_UI_CONTAINER") || __overlay || regionDropdown,
              getCurrentTheme: () => currentTheme,
            });
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:721", error); }

          buttonContainer.append(refreshButton, recentButton);
          ...
          try { rsdDisableTooltips(regionDropdown); } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:772", error); }
        ...
        function rsdIsElementVisible(el) {
          ...
          try {
            if (
              ...
              return false;
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:797", error); }
        ...
        function rsdIsPlayButtonReady(el) {
          ...
          try {
            ...
            const r = el.getBoundingClientRect();
            if (r.width <= 0 || r.height <= 0) return false;
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:849", error); }
          return true;
        }
        ...
        async function rsdWaitForRobloxPlayReady(el) {
          ...
          rsdPlayReadyPromise = (async () => {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:883", error); }
        ...
        function rsdEnsurePlayHook(regionDropdown, regionListContainer) {
          if (!window.__rsdPointerTrackerInstalled) {
            ...
            const upd = (e) => {
              ...
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:932", error); }
            };
            ...
            if (
              ...
              rsdWaitForRobloxPlayReady(btn)
                .then((ok) => {
                  ...
                  } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:957", error); }
                  if (!ok) return;
                ...
                .catch(() => {
                  try {
                    delete btn.dataset.rsdHoverAttaching;
                  } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:973", error); }
                });
            }
          }
          ...
          const schedule = () => {
            ...
            setTimeout(() => {
              ...
              try {
                rsdEnsurePlayHook(regionDropdown, regionListContainer);
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:987", error); }
            }, 120);
          };
          try {
          ...
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:996", error); }
        }
        ...
        function rsdPreparePlayIcon(playButton) {
          ...
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1011", error); }
        }
        ...
        function rsdAttachPlayHoverAndIntercept(
          ...
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1029", error); }
          let closeTimer = null;
          ...
          function rsdSetPlayReady(on) {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1049", error); }
          }
          ...
          function positionDropdown() {
            try {
              ...
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1097", error); }
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1114", error); }
          }
          ...
          async function doOpen() {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1147", error); }
            ...
            try {
              await regionServersPopulate(regionListContainer);
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1165", error); }
          }
          ...
          function rsdCloseSidePanelNow() {
            try {
              ...
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1178", error); }
              try {
                const btn = document.getElementById("rsd-recent-btn");
                if (btn) btn.classList.remove("rsd-panel-open");
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1182", error); }

              if (bridge) bridge.style.pointerEvents = "none";
              try {
                if (bridge) bridge.remove();
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1187", error); }
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1188", error); }
          }
          ...
          function doCloseMain() {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1202", error); }

            try {
              regionDropdown.classList.add("rsd-closing");
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1206", error); }
            try {
              regionDropdown.classList.remove("rsd-open");
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1209", error); }
            hoverBridge.style.pointerEvents = "none";

            try {
              if (id != transitionId) return;
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1214", error); }
            state = "closed";
            try {
              regionDropdown.classList.remove("rsd-closing");
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1218", error); }
          }
          ...
          function isRsdUiTarget(node) {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1273", error); }
            return false;
          }
          if (!window.__rsdOutsideClickHooked) {
            ...
            document.addEventListener(
              ...
              (e) => {
                ...
                } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1287", error); }
              },
              true,
            );
          }
          ...
          window.__rsdCloseRegionDropdown = () => {
            try {
              desiredOpen = false;
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1296", error); }
            try {
              playButton.blur();
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1299", error); }
            try {
              if (state != "closed" && state != "closing") doCloseStaggered();
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1302", error); }
          };
          ...
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1347", error); }
          ...
          function rsdBlockPlayIfNotReady(e) {
            try {
              ...
              e.stopPropagation();
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1358", error); }
          }
        ...
        async function regionServersPopulate(listContainer) {
            ...
            listContainer.addEventListener(
              ...
              (e) => {
                ...
                if (regionSelectorShowServerlistPanel) {
                  ...
                  } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1440", error); }
          ...
          if (!cache || cache.signature !== signature) {
            ...
            for (const continent of sortedContinents) {
              ...
              regionsInGroup.forEach((region, index) => {
                ...
                nameSpan.style.cssText = `font-size: 14px; font-weight: 500; color: ${isDarkMode ? "#a0a0a0" : "#777777"}; flex: 1 1 auto; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;`;
            ...
            uName.style.cssText = `font-size: 14px; font-weight: 500; color: ${isDarkMode ? "#e0e0e0" : "#333333"}; flex: 1 1 auto; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;`;
          ...
          for (const region of regionsData) {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1731", error); }
          }
          if (
            cache.unknownHeader &&
            cache.unknownRow &&
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1744", error); }
          }
        }
        ...
        async function rsdOpenRegionSidePanel(regionCode, refreshOnly = false) {
          ...
          } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:1761", error); }
        }
...
`;
        ...
        function createServerFetch(
          ...
          for (let i = 0; i < thumbsToRender; i++) {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:2033", error); }
          ...
          if (desiredThumbCount > maxThumbnails) {
            ...
            } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:2042", error); }
          ...
          if (!joinButton.disabled) {
            joinButton.onclick = () => {
              ...
              try {
                if (typeof window.__rsdCloseRegionDropdown === "function")
                  window.__rsdCloseRegionDropdown();
              } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:2079", error); }
            };
          }
  ...
  } catch (error) { rsdWarnOnce("src/content/page/modules/region_panel/ui.js:2146", error); }
})();
