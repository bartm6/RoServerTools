...
globalThis.RSD = globalThis.RSD || {};
  ...
  function createApi(env) {
    ...
    const log = (() => {
      try {
        return (globalThis.RSD?.utils?.createLogger || ((_s) => console))("api");
      } catch {
        return console;
      }
    })();
    ...
    function dbg(...args) {
      ...
      } catch (error) { rsdWarnOnce("src/content/page/modules/api.js:43", error); }
    }
    ...
    function rsdParseLatLonFromSessionId(sessionId) {
      ...
      } catch (error) { rsdWarnOnce("src/content/page/modules/api.js:85", error); }
      return null;
    }
    ...
    async function handleServer(server, placeId, _targetRegions, specificRegion = null) {
      ...
      function maybeAddToRegionList(regionCode) {
        try {
          ...
          } catch (error) { rsdWarnOnce("src/content/page/modules/api.js:136", error); }
          F.scheduleUiUpdate();
        } catch (e) {
    ...
    async function getServerInfo(placeId, regions, initialCall = true, cursor = null, specificRegion = null) {
      ...
      try {
        ...
        F.updateDetailsServers().catch((error) => rsdWarnOnce("src/content/page/modules/api.js:updateDetailsServers", error));
